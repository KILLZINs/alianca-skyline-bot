...
export default {
  category: 'utility',
  data: new SlashCommandBuilder().setName('serverinfo').setDescription('Exibe informações sobre o servidor'),
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = baseEmbed(COLORS.PRIMARY)
      ...
      .addFields(
        ...
        { name: '💬 Canais de Texto', value: `**${textCh}**`, inline: true },
        { name: '🔊 Canais de Voz', value: `**${voiceCh}**`, inline: true },
        { name: '📋 Cargos', value: `**${g.roles.cache.size}**`, inline: true },
        { name: '😀 Emojis', value: `**${g.emojis.cache.size}**`, inline: true },
        { name: '✅ Verificação', value: `**${g.verificationLevel}**`, inline: true },
      )
