...
exports.CLASS_MISSIONS = void 0;
exports.getMissionsForClass = getMissionsForClass;
exports.CLASS_MISSIONS = [
    // ── Todas as classes ─────────────────────────────────────────────
...
function getMissionsForClass(playerClass) {
    const applicable = exports.CLASS_MISSIONS.filter(m => m.classes.includes('*') || m.classes.includes(playerClass));
