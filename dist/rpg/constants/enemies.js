...
exports.ENEMY_LIST = exports.ENEMIES = void 0;
exports.getEnemy = getEnemy;
exports.getEnemiesForLocation = getEnemiesForLocation;
exports.getBossesForLocation = getBossesForLocation;
...
exports.ENEMY_LIST = Object.values(exports.ENEMIES);
function getEnemy(id) {
    return exports.ENEMIES[id];
}
function getEnemiesForLocation(locationId, playerLevel) {
    return exports.ENEMY_LIST.filter(e => e.locationIds.includes(locationId) &&
        e.type !== 'boss' && e.type !== 'raid' &&
        playerLevel >= e.minLevel &&
        (e.maxLevel === undefined || playerLevel <= e.maxLevel + 5));
}
function getBossesForLocation(locationId) {
    return exports.ENEMY_LIST.filter(e => e.locationIds.includes(locationId) && e.type === 'boss');
}
