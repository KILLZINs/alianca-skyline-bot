...
function channelTypeName(type) {
    const map = {
        ...
        [discord_js_1.ChannelType.GuildMedia]: 'Mídia',
...
exports.default = {
    ...
    async execute(channel) {
        if (!channel.guild)
            return;
        await (0, logger_1.sendLog)(channel.guild, logger_1.LOG.CHANNELS, (0, logger_1.logChannelCreate)(channel.name, channel.id, channelTypeName(channel.type)));
    },
};
