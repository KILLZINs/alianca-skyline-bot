...
exports.default = {
    ...
    async execute(interaction) {
        ...
        const row2 = new discord_js_1.ActionRowBuilder().addComponents(new discord_js_1.ButtonBuilder().setCustomId('painel:economia').setLabel('Economia').setEmoji('🪙').setStyle(discord_js_1.ButtonStyle.Primary), new discord_js_1.ButtonBuilder().setCustomId('painel:loja').setLabel('Loja').setEmoji('🛍️').setStyle(discord_js_1.ButtonStyle.Primary), new discord_js_1.ButtonBuilder().setCustomId('painel:missoes').setLabel('Missões').setEmoji('🔥').setStyle(discord_js_1.ButtonStyle.Primary));
        const row3 = new discord_js_1.ActionRowBuilder().addComponents(new discord_js_1.ButtonBuilder().setCustomId('painel:ticket').setLabel('Suporte').setEmoji('🎫').setStyle(discord_js_1.ButtonStyle.Success), new discord_js_1.ButtonBuilder().setCustomId('painel:sorteios').setLabel('Sorteios').setEmoji('🎁').setStyle(discord_js_1.ButtonStyle.Success), new discord_js_1.ButtonBuilder().setCustomId('painel:eventos').setLabel('Eventos').setEmoji('📌').setStyle(discord_js_1.ButtonStyle.Success));
